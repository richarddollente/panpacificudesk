...
namespace Illuminate\Support\Facades {
     ...
     * @method static void listen(array|\Closure|string $events, \Closure|null|string $listener = null)
     * @see \Illuminate\Support\Traits\Macroable::hasMacro
     * @method static bool hasMacro(string $name)
     ...
     * @method static \Illuminate\Http\Client\PendingRequest attach(string $name, string $contents, null|string $filename = null, array $headers = [])
     ...
     * @method static mixed queue(\Illuminate\Contracts\Mail\Mailable $view, null|string $queue = null)
